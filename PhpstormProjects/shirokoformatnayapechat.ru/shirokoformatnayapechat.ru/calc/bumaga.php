...
<h2>Расчет стоимости широкоформатной печати на бумаге</h2>
<br>
<?php ######## CALCULATOR  index v 1.00 !!!  ######### ?>
<div class="row">
    ...
    <div class="col-md-9">
        2. Выберите вариант бумаги:<br>
        <select size="1" name="mat" class="btn btn-info form-control">
            <option selected="selected" value="0">Выбрать тип бумаги</option>
        </select>
    </div>
</div>
<br>
...
<div id="calc_all_prices">
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="form-group">
                <label class="col-sm-6 control-label">Цена печати 1м<sup>2</sup>:</label><input name="price_m" placeholder="0" disabled="disabled" size="4" type="text"> руб.
            </div>
        </div>
    </div>
    <!--div class="row">
...
<script>
    $(document).ready(function(){
        ...
        var mat = {
            185:{
                901:{name:'Бумага постерная 150 гр. SkyLight Матовая',price_1_100:245,price_101_300:200,price_301_1000:160,price_1001:160},
                902:{name:'Бумага постерная 150 гр. SkyLight Глянцевая',price_1_100:245,price_101_300:200,price_301_1000:160,price_1001:160},
                903:{name:'Скроллерная бумага 170 гр. PRISMAFLEX Матовая/Гляцевая',price_1_100:470,price_101_300:445,price_301_1000:440,price_1001:440},
                904:{name:'Фотобумага 220 гр. Матовая/Глянцевая',price_1_100:450,price_101_300:425,price_301_1000:390,price_1001:390},
            },
            187:{
                901:{name:'Бумага постерная 150 гр. SkyLight Матовая',price_1_100:260,price_101_300:215,price_301_1000:170,price_1001:170},
                902:{name:'Бумага постерная 150 гр. SkyLight Глянцевая',price_1_100:260,price_101_300:215,price_301_1000:170,price_1001:170},
                903:{name:'Скроллерная бумага 170 гр. PRISMAFLEX Матовая/Гляцевая',price_1_100:490,price_101_300:460,price_301_1000:415,price_1001:415},
                904:{name:'Фотобумага 220 гр. Матовая/Глянцевая',price_1_100:465,price_101_300:440,price_301_1000:400,price_1001:400},
            },
            188:{
                901:{name:'Бумага постерная 150 гр. SkyLight Матовая',price_1_100:360,price_101_300:315,price_301_1000:270,price_1001:270},
                902:{name:'Бумага постерная 150 гр. SkyLight Глянцевая',price_1_100:360,price_101_300:315,price_301_1000:270,price_1001:270},
                903:{name:'Скроллерная бумага 170 гр. PRISMAFLEX Матовая/Гляцевая',price_1_100:590,price_101_300:560,price_301_1000:515,price_1001:515},
                904:{name:'Фотобумага 220 гр. Матовая/Глянцевая',price_1_100:565,price_101_300:540,price_301_1000:500,price_1001:500},
            }
        ...
        function recalc()
        {
            ...
            var price_mat = 0; // Цена 1м<sup>2</sup> материала
            ...
            if(square_m && imat!=0 && idpi!=0)
            {
                ...
                $('#calc_data_banner').append($('input[name="price_m"]').val()+' руб. (по цене за 1м<sup>2</sup>); \r\n\r');

                $('#calc_data_banner').append($('input[name="hei"]').val()+' мм. - Высота; ');
                $('#calc_data_banner').append($('input[name="wid"]').val()+' мм. - Ширина; ');
                $('#calc_data_banner').append($('input[name="square"]').val()+' м<sup>2</sup> - Площадь; ');
        ...
        $('.minus').click(function () {var $input = $(this).parent().find('input'); var count = parseInt($input.val()) - 1; count = count < 1 ? 1 : count; $input.val(count); $input.change(); return false;});
        $('.plus').click(function () {var $input = $(this).parent().find('input'); $input.val(parseInt($input.val()) + 1); $input.change(); return false;});
