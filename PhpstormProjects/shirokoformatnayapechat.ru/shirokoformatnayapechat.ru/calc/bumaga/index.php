...
<style type="text/css">
    ...
    <h1 align="center">Расчет стоимости широкоформатной печати на бумаге</h1>
    <br>
            ...
            <div class="col-sm-7 five-three">
                <div class="row">
                    <!--div class="col-sm-4">
                        <div class="option setting_row">
                            <p class="title_option">
                                <img src="../calc/icon_option1.png" alt=""><span class="setting_title">Люверсы</span>
                            </p>
                    ...
                    <!--div class="col-sm-4">
                        <div class="option setting_row">
                            <p class="title_option">
                                <img src="../calc/icon_option3.png" alt=""><span class="setting_title">Проварка краев</span>
                            </p>
                    ...
                    <div class="col-sm-4">
                        <div class="option setting_row">
                            <p class="title_option">
                                <img src="../calc/icon_option4.png" alt=""><span class="setting_title">Резка в размер</span>
                            </p>
            ...
            <div class="col-sm-5 five-two">
                <div class="row">
                    <!--div class="col-sm-6">
                        <div class="option setting_row">
                            <p class="title_option">
                                <img src="../calc/icon_option5.png" alt=""><span class="setting_title">Усиление шнуром</span>
                            </p>
                    ...
                    <!--div class="col-sm-6">
                        <div class="option setting_row">
                            <p class="title_option">
                                <img src="../calc/icon_option2.png" alt=""><span class="setting_title">Проклейка кармана </span>
                            </p>
