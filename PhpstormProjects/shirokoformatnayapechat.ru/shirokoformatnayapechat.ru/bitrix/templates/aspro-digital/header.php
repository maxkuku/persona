        ...
        <script type="application/ld+json">
{
  ...
  "image" : "http://shirokoformatnayapechat.ru/logo.png",
  "telephone" : "8 (495) 121-79-29",
  "email" : "1217929@mail.ru",
  "address" : {
    "@type" : "PostalAddress",
    "streetAddress" : "Ул. Свободы 35с5",
...
<style>
	.right-icons .inner-table-block {
		...
		<script type="text/javascript" src="https://cdn.envybox.io/widget/cbk.js?wcb_code=16ffb396b6d0d245dd51f823fbef344c" charset="UTF-8" async></script>
	...
	<body class="mheader-v<?=$arThemeValues["HEADER_MOBILE"];?> header-v<?=$arThemeValues["HEADER_TYPE"];?> title-v<?=$arThemeValues["PAGE_TITLE"];?><?=($arThemeValues['ORDER_VIEW'] == 'Y' && $arThemeValues['ORDER_BASKET_VIEW']=='HEADER'? ' with_order' : '')?><?=($arThemeValues['CABINET'] == 'Y' ? ' with_cabinet' : '')?><?=(intval($arThemeValues['HEADER_PHONES']) > 0 ? ' with_phones' : '')?>">
        ...
        <noindex>
        <?$APPLICATION->IncludeComponent("shiroko:quick.form","", array(),array(), false);?>
        </noindex>
        <?
		...
		<div class="body <?=($isIndex ? 'index' : '')?> hover_<?=$arTheme["HOVER_TYPE_IMG"]["VALUE"];?>">
			...
			<div role="main" class="main banner-<?=$arTheme["BANNER_WIDTH"]["VALUE"];?> <?=str_replace("/", "", $APPLICATION->GetCurDir())?>">
								...
								<?elseif($isMenu && $arTheme["SIDE_MENU"]["VALUE"] == "LEFT" && !$isBlog):?>
									<div class="col-md-3 col-sm-3 hidden-xs hidden-sm left-menu-md">
										<?$APPLICATION->IncludeComponent(
											"bitrix:menu","left",
											array(
												"ROOT_MENU_TYPE" => ($isCabinet ? "cabinet" : "left"),"MENU_CACHE_TYPE" => "A","MENU_CACHE_TIME" => "3600000","MENU_CACHE_USE_GROUPS" => ($isCabinet ? "Y" : "N"),"MENU_CACHE_GET_VARS" => array(
												),
												"MAX_LEVEL" => "4","CHILD_MENU_TYPE" => "left","USE_EXT" => "Y","DELAY" => "N","ALLOW_MULTI_SELECT" => "Y","COMPONENT_TEMPLATE" => "left"
											),
											false
										);?>
										<div class="sidearea">
											...
											<?$APPLICATION->IncludeComponent(
												...
												array(
													"AREA_FILE_SHOW" => "sect","AREA_FILE_SUFFIX" => "sidebar",
													"AREA_FILE_RECURSIVE" => "Y","COMPONENT_TEMPLATE" => ".default","EDIT_TEMPLATE" => "include_area.php"
												),
												false
											);?>
										</div>
...
<a class="scroll-to-top ROUND_COLOR PADDING visible" href="#" id="xscrollToTop"></a>