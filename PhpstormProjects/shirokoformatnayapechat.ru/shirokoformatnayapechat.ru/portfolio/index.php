...
$APPLICATION->SetPageProperty("description", "Примеры широкоформатной печати в Москве, выполненные нашей компанией. Нравится? Звоните для заказа широкоформатной продукции прямо сейчас ☎ +7 (495) 121-79-29");
$APPLICATION->SetPageProperty("keywords", "портфолио");
$APPLICATION->SetPageProperty("title", "Примеры широкоформатной печати в Москве");
