...
while($arNav = $nav->GetNext())
{
	...
	{	
		$APPLICATION->AddChainItem($arNav['NAME'], "/catalog/section.php?SECTION_ID=".$arNav['ID']);
	
	}else{
		$APPLICATION->AddChainItem($arNav['NAME'], "/catalog/list.php?SECTION_ID=".$arNav['ID']);
	}
	
}

$APPLICATION->AddChainItem($arResult['NAME'], "/catalog/detail.php?ID=".$arNav['ID']);
