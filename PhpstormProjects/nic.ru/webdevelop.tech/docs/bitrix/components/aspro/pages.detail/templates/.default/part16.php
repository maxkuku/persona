...
<div class="maxwidth-theme">
		<h3 class="text-center"><?=$arResult['PROPERTIES']['calc_zagolok']['VALUE'];?></h3>	
        ...
        <div class="calc-room-type__items">
				...
				<div class="calc-room-type__item js-select-item">
                    <label for="calc-id-4">
                            ...
                            <img src="<?=($arResult['PROPERTIES']['calc_images']['VALUE'][0]?CFile::GetPath($arResult['PROPERTIES']['calc_images']['VALUE'][0]):'https://www.remontprofi.ru/files/402/calc-room-2.jpg');?>">
				...
				<div class="calc-room-type__item js-select-item">
                    <label for="calc-id-5">
                                                <div class="calc-room-type__pic">
                           <img src="<?=($arResult['PROPERTIES']['calc_images']['VALUE'][1]?CFile::GetPath($arResult['PROPERTIES']['calc_images']['VALUE'][1]):'https://www.remontprofi.ru/files/402/calc-room-3.jpg');?>">
                            <div class="calc-room-type__btn">
                                <span>Рассчитать</span>
                            </div>
                        </div>
				...
				<div class="calc-room-type__item js-select-item calc-room-type__item--on">
                    <label for="calc-id-3">
                                                <div class="calc-room-type__pic">
                            <img src="<?=($arResult['PROPERTIES']['calc_images']['VALUE'][2]?CFile::GetPath($arResult['PROPERTIES']['calc_images']['VALUE'][2]):'https://www.remontprofi.ru/files/402/calc-room-1.jpg');?>">
                ...
                <div class="calc-room-type__item js-select-item">
                    <label for="calc-id-6">
                                                <div class="calc-room-type__pic">
                            <img src="<?=($arResult['PROPERTIES']['calc_images']['VALUE'][3]?CFile::GetPath($arResult['PROPERTIES']['calc_images']['VALUE'][3]):'https://www.remontprofi.ru/files/402/calc-room-4.jpg');?>">
                            <div class="calc-room-type__btn">
                                <span>Рассчитать</span>
                            </div>
                        </div>
            ...
            <div class="calc-remont-type__content">
                        ...
                        <div class="calc-remont-type__item">
                            <label for="calc-remont-type-id-1">
                                ...
                                Косметический (класс С)
                            </label>
                            <div class="calc-remont-type__detail">
                                <a target="_blank" href="#">Подробнее</a>
                            </div>
                        </div>
