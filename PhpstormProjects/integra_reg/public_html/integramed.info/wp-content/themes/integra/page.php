...
?>
    ...
    <?}?>
    <?if($post->ID == 991
        || get_root_parent_id( $post->ID ) == 991){?>
        <?php  dynamic_sidebar( 'specs-side-bar' ); ?>
    <?}?>
    <?if($post->ID == 190
    ...
    <?if($post->ID == 202
        || $post->ID == 2513
        || get_root_parent_id( $post->ID ) == 202){?>
        <?php  dynamic_sidebar( 'services-side-bar' ); ?>
    <?}?>
    <?if($post->ID == 2483
        || get_root_parent_id( $post->ID ) == 2483){?>
        <?php  dynamic_sidebar( 'onco-side-bar' ); ?>
    <?}?>
            </ul>
