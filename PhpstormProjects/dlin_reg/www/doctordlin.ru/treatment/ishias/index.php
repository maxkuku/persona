...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения ишиаса");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения ишиаса");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap">
        <h1>Эффективное лечение ишиаса</h1>
        <div class="block white flexed">
           <a href="<?=SITE_TEMPLATE_PATH?>/images/ishias.jpg" rel="lightbox"><img src="<?=SITE_TEMPLATE_PATH?>/images/ishias.jpg" alt="Ишиас"/></a>
            <div>
                ...
                <p class="redtext">Ишиас это заболевание, которое спровоцировано защемлением седалищного нерва, наличием воспалительного процесса в пояснично-крестцовом отделе позвоночника.</p>
