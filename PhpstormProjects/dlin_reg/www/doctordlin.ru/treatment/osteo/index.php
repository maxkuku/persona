...
$APPLICATION->SetTitle("Остеохондроз");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap">
        <h1>Современное лечение остеохондроза</h1>
<img  width="500" hspace="9" vspace="9" align=right src="/bitrix/templates/dlin/images/ost.jpg">
<p>Остеохондроз -  это хроническое заболевание позвоночника, которое поражает межпозвоночные диски и хрящи. Первые проявления остеохондроза часто возникают в 25- 30 лет, а после 40 лет у большинства людей наблюдаются симптомы характерные для различных стадий остеохондроза.</p>


	<p>Важно начать лечение как можно быстрее, пока хрящевая ткань не начала костенеть и диск не начал разрушаться. Пока позвонки и диски сохраняют подвижность процесс можно остановить. Правильное лечение запускает восстановление позвоночника.</p> 


		<h2>Методы диагностики остеохондроза</h2>
<p>Специалисты «Клиники доктора Длина» определяют остеохондроз на ранней стадии с помощью следующих методов диагностики:</p>

<ul>
<li>Детальный неврологический осмотр с выявлением нарушения рефлексов и зон чувствительности. Специалисты детально определять уровень поражения позвоночника и конкретных межпозвонковых дисков. С помощью мануальной диагностики определят наличие смещений позвонков (листезы, нестабильность позвонков).</li>
<li>МРТ покажет состояние межпозвоночных дисков, при наличии грыжи диска точно будет определены размеры грыжи, где происходит сдавление нервного корешка</li>
<li>Рентген покажет распространённость остеохондроза, высоту межпозвонковых дисков, наличие искривлений позвоночника и смещения позвонков.</li>
<li>Ультразвуковая допплерография покажет наличие изменения кровотока сосудов шеи в позвоночной и сонной артерии</li>
<li>Лабораторные исследования. </li>
	</ul>



		<h2>Лечение остеохондроза в клинике доктора Длина</h2>
        <div class="block white flexed">
           <a href="<?=SITE_TEMPLATE_PATH?>/images/protruzia.jpg" rel="lightbox"><img src="<?=SITE_TEMPLATE_PATH?>/images/protruzia.jpg" alt="Протрузия"/></a>
            <div>
                ...
                <p class="redtext">Мы используем собственный авторский метод комплексного лечения остеохондроза с применением фотодинамической Ди-тазин терапии.</p>
                <p>Врачи «клиники доктора Длина» более 18 лет лечат остеохондроз консервативными методами. Мы используем 20 безоперационных методов, чтобы избавиться от болезни и купировать болевой синдром. Консервативное лечение снимает симптомы и останавливает развитие остеохондроза.</p>
            </div>
        </div>
    </div>
...
<p>Основатель клиники, Сергей Владимирович Длин, привнес в мануальную терапию прогрессивные западные направления, и создал авторские методики лечения, дающие стабильный результат, сохраняющийся на долгое время.</p>
    ...
    <div class="wrap">
        ...
        <div>
            ...
            <img width="400" align="left" hspace="30" vspace="20" src="<?=SITE_TEMPLATE_PATH?>/images/di-tazin.webp" onerror="this.onerror=null; this.src='<?=SITE_TEMPLATE_PATH?>/images/di-tazin.jpg'">
            </a>
            <div>
