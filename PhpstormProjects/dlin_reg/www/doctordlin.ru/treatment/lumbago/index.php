...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения люмбаго");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения люмбаго");
$APPLICATION->SetTitle("Люмбаго");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap">
        <h1>Авторская методика лечения люмбаго</h1>
