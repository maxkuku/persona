...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения межреберной невралгии");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения межреберной невралгии");
