...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения защемления нерва");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения защемления нерва");
$APPLICATION->SetTitle("Защемление нерва");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap">
        <h1>Авторская методика лечения защемления нерва</h1>
