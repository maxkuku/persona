...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения спондилеза");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения спондилеза");
$APPLICATION->SetTitle("Спондилез");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap">
        <h1>Авторская методика лечения спондилеза</h1>
