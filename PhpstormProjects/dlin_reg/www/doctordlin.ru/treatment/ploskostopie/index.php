...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения плоскостопия");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения плоскостопия");
$APPLICATION->SetTitle("Плоскостопие");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap" itemscope="" itemtype="http://schema.org/Article" itemprop="articleBody">
        <h1>Авторская методика лечения плоскостопия</h1>
