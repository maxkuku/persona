...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения сколиоза");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения сколиоза");
$APPLICATION->SetTitle("Сколиоз");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap">
        <h1>Авторская методика лечения сколиоза</h1>
