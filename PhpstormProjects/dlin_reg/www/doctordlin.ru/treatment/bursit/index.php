...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения бурсита");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения бурсита");
$APPLICATION->SetTitle("Бурсит");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap" itemscope="" itemtype="http://schema.org/Article" itemprop="articleBody">
        <h1>Авторская методика лечения бурсита</h1>
        <div class="block white flexed">
           <a href="<?=SITE_TEMPLATE_PATH?>/images/bursit.jpg" rel="lightbox"><img src="<?=SITE_TEMPLATE_PATH?>/images/bursit.jpg" alt="Бурсит"/></a>
            <div>
                ...
                <p class="redtext">Защемление седалищного нерва чаще всего появляется в пожилом возрасте на фоне комплекса патологий в позвоночнике.</p>
