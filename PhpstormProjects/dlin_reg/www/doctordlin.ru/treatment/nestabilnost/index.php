...
$APPLICATION->SetPageProperty("description", "Авторская методика лечения нестабильности позвонков");
$APPLICATION->SetPageProperty("title", "Авторская методика лечения нестабильности позвонков");
$APPLICATION->SetTitle("Нестабильность позвонков");
...
?>    <div class="wrap breadcrumbs">
    ...
    <div class="wrap">
        <h1>Лечение нестабильности позвонков</h1>
