            ...
            <div class="maxwidth-theme">
                <div class="col-md-12">
                    <div class="item-views catalog1 teasers front icons sections blocks">
                        <h2 class="text-center cfonts"><?= $arResult['PROPERTIES']['uslugi_title']['VALUE']; ?></h2>
                        <div class="items row margin0 ">
                            ...
                            <? foreach ($arResult['PROPERTIES']['uslugi_main']['VALUE'] as $iteam) { ?>	
                                <? $URL = $arResult['PROPERTIES']['uslugi_main_img']['VALUE'][$i]; 
										$ALT = $arResult['PROPERTIES']['alt_img_uslugi']['VALUE'][$i]; ?>
                                        ...
                                        <div class="info">
                                            ...
                                            <?/* if ($ii > 5) { ?>			
                                                <div class="link-block-more">
                                                    <a href="#" class="btn-inline sm rounded black show_all_uslugi" title="<?= $i; ?>" >
