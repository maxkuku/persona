...
<div id="part15" class=" margin0 block-with-bg ">
	...
	<div class="wpb_text_column wpb_content_element">
		<div class="wpb_wrapper">
			...
			<?$URL = $arResult['PROPERTIES']['viezd_video']['VALUE'];?>
	...
	<div class="wpb_column vc_column_container col-sm-2  ">
		<div class="vc_column-inner ">
			<div class="wpb_wrapper">
				...
				<div class="">
					<span class="animate-load twosmallfont colored  btn btn-default2 btn-lg  animate-load" data-event="jqm" data-param-id="<?= $arResult['PROPERTIES']['viezd_id_form']['VALUE']; ?>" data-name="<?= $arResult['PROPERTIES']['viezd_ssilka']['VALUE']; ?>"><?= $arResult['PROPERTIES']['viezd_namebutt']['VALUE']; ?></span>
					</div>
