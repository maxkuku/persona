	...
	<div class="row margin0 block-with-bg">
		<div class="maxwidth-theme">
			<div class="col-md-12">
				...
				<h2 class="text-center cfonts"><?=$arResult['PROPERTIES']['preimushestva_zagolok']['VALUE'];?></h2>
					<div class="items row">
								...
								<div class="inner-item">
									<div class="image shine">
										<a href="<?=$arResult['PROPERTIES']['preimushestva_link']['VALUE'][$i];?>">
											<img title="<?= $arResult['PROPERTIES']['alt_img_nashipreim']['~VALUE'][$i]; ?>" alt="<?= $arResult['PROPERTIES']['alt_img_nashipreim']['~VALUE'][$i]; ?>" src="<?=$arResult['PROPERTIES']['preimushestva_foto']['VALUE'][$i];?>" >
										</a>											
									</div>
									<div class="title">
										<a href="<?=$arResult['PROPERTIES']['preimushestva_link']['VALUE'][$i];?>">												
