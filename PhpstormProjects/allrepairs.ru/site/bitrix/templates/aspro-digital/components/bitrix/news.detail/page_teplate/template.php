...
$this->addExternalCss(SITE_TEMPLATE_PATH."/css/owl.theme.default.css");
...
$this->addExternalJS(SITE_TEMPLATE_PATH."/js/owl/owl.carousel.js");
$this->addExternalJS(SITE_TEMPLATE_PATH."/js/owl/owl.animate.js");
$this->addExternalJS(SITE_TEMPLATE_PATH."/js/owl/owl.autoheight.js");
$this->addExternalJS(SITE_TEMPLATE_PATH."/js/owl/owl.autoplay.js");
...
<? }
    ...
    <?php //рекламная лента ?>
    <? include('part41.php'); ?>
    <?php //блок цен allcorp2 отдельный ?>
    <? include('part42.php'); ?>
    <?
    //блок цен priority отдельный ?>
    <? include('part43.php'); ?>
    <?//НАШИ УСЛУГИ ?>
