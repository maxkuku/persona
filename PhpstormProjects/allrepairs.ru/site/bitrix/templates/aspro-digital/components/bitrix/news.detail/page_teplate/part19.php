...
<div id="part19" class="row margin0 company-block block-with-bg" style="background: url('//www.allrepairs.ru/images/bg_sert.jpg') center -194px / 100% no-repeat;" data-type="parallax-bg">
	...
	<? 	$i=0;				 
		...
		<div class="col-sm-4" >		
			<a href="<?=$URL;?>" class="blink-block fancybox" data-fancybox-group="gallery2">
				<img width="350" height="319" src="<?=$URL;?>" class="vc_single_image-img attachment-full" alt="<?=$arFields['NAME']?>">
			</a>
		</div>
	<?
	}
...
<?} else if ($arResult['PROPERTIES']['certif_list']['VALUE']) { ?>
