...
if (isset($arResult['ITEM']))
{
	...
	<div class="product-layout product-grid col-lg-3 col-md-3 col-sm-3 col-xs-12" data-bal="element-bal" data-type="<?=$arResult['TYPE']?>" data-temp="catalog-item">
		<?
		...
		else
		{
			$jsParams = array(
				...
				'PRODUCT' => array(
					...
					'NAME' => $productTitle,
					'DETAIL_PAGE_URL' => $item['DETAIL_PAGE_URL'],
					'PROPERTIES' => array('PROPERTY_BRAND','PROPERTY_QUANTITY','PROPERTY_PRICE','PROPERTY_HIT'),
					'MORE_PHOTO' => $item['MORE_PHOTO'],
					'MORE_PHOTO_COUNT' => $item['MORE_PHOTO_COUNT']
				),
				'OFFERS' => array(),
	...
	</div><!--interesting /div losted somewhere <?=__FILE__ . " " . __LINE__ ?>-->
