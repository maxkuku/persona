                                    ...
                                    <div class="main-image" href="#"
                                       title="<?= $arResult['NAME'] ?>" data-number="0">
                                        <img src="<?= $arResult['PREVIEW_PICTURE']['SRC'] ?>"
                                             ...
                                             onerror="this.src='<?=SITE_TEMPLATE_PATH?>/images/<?=strtolower(str_replace(' ', '-', $arResult['PROPERTIES']['brand']['VALUE']))?>-pale.jpg'; this.setAttribute('data-err', 'true')">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7  col-md-8 col-sm-12">
                                        ...
                                        <div class="addtocart-group">
                                            ...
                                            <!--/noindex-->
                                            <button class="btn btn-danger gradiented" data-toggle="tooltip" data-original-tooltip="Быстрый заказ" id="button-fastorder"
                        ...
                        <div id="tab-html-3" class="tab-pane">
                            <div id="ascpw3_div_comment_<?= $arResult['ID'] ?>">
                                ...
                                <div id="ascpw3_comment_<?= $arResult['ID'] ?>">
                                    <div class="container_comments" id="container_comments_product_id_<?= $arResult['ID'] ?>">
                                        <!-- <noindex> -->
                                        <div class="container_comments_vars acc3"
                                             id="container_comments_vars_product_id_<?= $arResult['ID'] ?>" style="display: none">
        ...
        foreach ($r[5] as $feed){
            $useful++;
                                                            ...
                                                            <div class="sc-reviews-stat_column sc-reviews-stat_column_theme_blue sc-stat-good">
                                                                <span class="sc-reviews-stat__value sc-stat-text-center"><?=$r[6]?>%</span>
                                                ...
                                                <div class="comment_block">
                                                    ...
                                                    <div class="seocms_author">
                                                        <div class="row">
                                                            <div class="col-sm-8 col-xs-7">
                                                                ...
                                                                <span class="stars">
                                                                    <?for($i=1; $i<=5; $i++){?>
                                                                        <i class="fa fa-star <?if($i<=$arFeed[4]){ echo "active"; }?>"></i>
                                                                    <?}?>
															</span>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="com_text color_000">
                                                        ...
                                                        <div class="block_fields">
					                                        ...
					                                        <span class="stars">
                                                                <?for($i=1; $i<=5; $i++){?>
                                                                    <i class="fa fa-star <?if($i<=$arFeed[8]){ echo "active"; }?>"></i>
                                                                <?}?>
                                                            </span>
                                                                </div>
                                                            </div>
                        ...
                        <div class="tab-pane" id="tab-html-2">
                            ...
                            <div id="cmswidget-section-2">
                                ...
                                <p>Доставка по Москве и и ближайшему Подмосковью осуществляется с понедельника по
                                    субботу через день после подтверждения и обработки заказа. К примеру: вы оформили
                                    заказ до 13.00 в понедельник, то доставка в среду. Доставка в Санкт-Петербург
                                    осуществляется с понедельника по пятницу на 2 будний день после передачи заказа в
                                    курьерскую службу. Заказы сделанные в выходные и праздничные дни обрабатываются на
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active fade in" id="moskva">
                                        <div class="delivery_courier col-sm-6">
                                            ...
                                            <ul>
                                                <li><span style="color:#FF0000;">Бесплатная доставка</span> при сумме
                                                    покупки 3000 рублей
                                                </li>
                                                <li>Доставка в пределах МКАД 250 рублей</li>
                                                <li>Доставка за пределы МКАД от 350 рублей (есть бесплатная доставка)
                                                </li>
