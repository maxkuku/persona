...
<div class="row">
	<div class="col-lg-12 col-xs-12 products-filter text-center">
		...
		<div class="btn-group">
			...
			<div class="btn-group" id="filter_manufacturer">
				<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
					<span class=" button-text">&nbsp;&nbsp;</span><i class="fa fa-angle-down caretalt"></i>
				</button>
				<? $des = CatalogSectionComponent::getBrandList($_REQUEST['SECTION_ID'], $_REQUEST['SECTION_CODE'])?>
				<?#pr($des)?>
				<ul class="dropdown-menu pull-right">
					<li><a href="/catalog/"><b>Все производители</b></a></li>
					<?foreach ($des as $r):?>
					<li class="<?=($r['PROPERTY_BRAND_VALUE'] == htmlspecialchars($_REQUEST['brand_name']))?"active":""?>"><a href="/catalog/brands/?brand_name=<?=$r['PROPERTY_BRAND_VALUE']?>"><?=$r['PROPERTY_BRAND_VALUE']?></a></li>
					<?endforeach?>
				</ul>
			</div>
		</div>
		...
		<div class="btn-group pull-right">
			<div class="btn-group" title="Сортировать:" id="sort-button">
				<button class="btn btn-default dropdown-toggle" id="num_to_show" type="button" data-toggle="dropdown">
					<i class="fa fa-sort"></i>&nbsp;&nbsp;
					<span class=" button-text">&nbsp;&nbsp;</span><i class="fa fa-angle-down caretalt"></i>
				</button>
				<ul class="dropdown-menu pull-right">
					<? #TODO: изменить. Получается /bitrix/urlrewrite.php/?sort=p.sort_order&amp;order=ASC?>
					<li><a href="<?=$_SERVER['PHP_SELF']?>?sort=p.sort_order&amp;order=ASC"><b>По умолчанию</b></a></li>
					<li><a href="<?=$_SERVER['PHP_SELF']?>?sort=p.price&amp;order=ASC">По цене (возрастанию)</a></li>
					<li><a href="<?=$_SERVER['PHP_SELF']?>?sort=p.price&amp;order=DESC">По цене (убыванию)</a></li>
					<li><a href="<?=$_SERVER['PHP_SELF']?>?sort=rating&amp;order=DESC">По рейтингу (убыванию)</a></li>
					<li><a href="<?=$_SERVER['PHP_SELF']?>?sort=rating&amp;order=ASC">По рейтингу (возрастанию)</a></li>
				</ul>
			</div>
			<div class="btn-group" title="Показывать:" id="limit-button">
				...
				<ul class="dropdown-menu pull-right">
					<li class="text-right"><a href="<?=$_SERVER['PHP_SELF']?>?limit=16"><b>16</b></a></li>
					<li class="text-right"><a href="<?=$_SERVER['PHP_SELF']?>?limit=25">25</a></li>
					<li class="text-right"><a href="<?=$_SERVER['PHP_SELF']?>?limit=50">50</a></li>
					<li class="text-right"><a href="<?=$_SERVER['PHP_SELF']?>?limit=100">100</a></li>
				</ul>
			</div>
		</div>
	</div>
