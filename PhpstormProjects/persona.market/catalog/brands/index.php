...
$APPLICATION->SetTitle("Каталог Бренды «Персона» маркет");
$from = ["%20"];
$to = [" "];
$brands = str_replace($from, $to, htmlspecialchars($_REQUEST['brand_name'],3));


if($brands){
    $filter = array("PROPERTY_BRAND"=>$brands);
}
