...
?>
<div class="search-page uk-block">
<form action="" class="uk-form form-404-search uk-form-horizontal" method="get">
...
<?else:?>
	<fieldset data-uk-margin="">
		<legend></legend>
		<input class="uk-margin-small-top" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" maxlength="150" />

<?endif;?>
<?if($arParams["SHOW_WHERE"]):?>
	&nbsp;<select name="where" class="uk-margin-small-top">
...
<?endif;?>
	&nbsp;<input type="submit" class="uk-button uk-button-success uk-margin-small-top" value="<?=GetMessage("SEARCH_GO")?>" />
