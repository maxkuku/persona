        ...
        $.flexslider = function(el, options) {
            ...
            methods = {
                init: function() {
                    ...
                    if (!fade || (fade && slider.vars.smoothHeight)) {
                        $(window).bind("resize orientationchange", methods.resize);
                    }
            ...
            slider.doMath = function() {
                ...
                if (carousel) {
                    ...
                    slider.visible = Math.floor((slider.itemT > slider.itemW ? slider.w + slider.itemM : slider.w) / (slider.itemT > slider.itemW ? slider.itemT : slider.itemW));
                    // ++ added by kach
